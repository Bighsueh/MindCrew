...
const TEACHER_STEPS: DriveStep[] = [
  {
    ...
    popover: {
      title: '歡迎來到專案列表',
      description:
        '這裡管理你所有的設計思考活動。每個專案會走完雙鑽石的四個階段，從訪談到原型一氣呵成。',
    },
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: '專案總覽',
      description: '一眼看出全部專案數、進行中、已完成的數量。',
      side: 'bottom',
    },
  },
  {
    ...
    popover: {
      title: '依階段篩選',
      description:
        '依雙鑽石階段（Discover / Define / Develop / Deliver）過濾，快速找到還沒收斂的專案。',
      side: 'bottom',
    },
  },
  {
...
const STUDENT_STEPS: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      title: '篩選與搜尋',
      description: '依雙鑽石階段過濾，或用關鍵字找你要進去的專案。',
      side: 'bottom',
    },
  },
  {
...
export function startProjectsTour(role: ProjectsTourRole): void {
  ...
  // 過濾掉找不到 anchor 的步驟，避免 driver.js 卡住（例：學生無 [data-tour="projects-create"]、無專案無 card）
